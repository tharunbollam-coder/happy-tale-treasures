      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center space-x-2 font-kid text-2xl mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="font-comic text-muted-foreground hover:text-primary transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/stories" className="font-comic text-muted-foreground hover:text-primary transition-colors">
                  All Stories
                </Link>
              </li>
              <li>
                <Link href="/about" className="font-comic text-muted-foreground hover:text-primary transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="font-comic text-muted-foreground hover:text-primary transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/privacy" className="font-comic text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
                  <Shield className="w-4 h-4" />
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="font-comic text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
                  <FileText className="w-4 h-4" />
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/contact" className="font-comic text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
