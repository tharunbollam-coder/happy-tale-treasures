...
export const stories: Story[] = [
  {
    ...
    content: [
      {
        text: `Once upon a time, in a beautiful meadow, there lived a very fast rabbit named Zippy and a slow tortoise named Shell.
...
Meanwhile, Shell kept walking. Step by step, slowly but surely, he moved forward. He never stopped, even when he felt tired.`,
        image: "/src/assets/tortoise-hare-2.jpg"
      },
      {
...
From that day on, Zippy and Shell became the best of friends, and they often raced together just for fun!`,
        image: "/src/assets/tortoise-hare-3.jpg"
      }
    ],
  ...
  },
  {
    ...
    content: [
      {
        text: `Once there were three little pig brothers named Straw, Stick, and Brick. It was time for them to build their own houses and live independently.
...
From then on, all three brothers worked together to build strong, safe homes for everyone in the forest.`,
        image: "/src/assets/three-pigs-3.jpg"
      }
    ],
  ...
  },
  {
    ...
    content: [
      {
        text: `In a sunny garden, there lived a busy little ant named Annie and a cheerful grasshopper named Hopper.
